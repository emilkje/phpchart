function SpeedometerChart(target, settings) {
    ...
    .attr('height', function(d){ return d.oRadius + d.margin; })
    .attr('width', function(d){ return (d.oRadius + d.margin)*2; });
	...
	var arc = d3.svg.arc()
		...
		.outerRadius(function(d){ return d.oRadius + (d.value2 ? 5 : 0); })
	...
	var arc3 = d3.svg.arc()
		...
		.outerRadius(function(d){ return d.oRadius + 5; })
		.startAngle(-90 * (pi/180))
		.endAngle(function(d){
